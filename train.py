...
def get_data_loaders(args, tokenizer):
    ...
    for dataset_name, dataset in datasets.items():
        ...
        for input_name in MODEL_INPUTS:
            # print(dataset[input_name].shape)
    ...
    print(tensor_datasets['train'][0].size())
    print(tensor_datasets["train"][1].size())
    print(tensor_datasets["train"][2].size())
    print(tensor_datasets["train"][3].size())
    print(tensor_datasets["train"][4].size())
    print(len(tensor_datasets["valid"]))
